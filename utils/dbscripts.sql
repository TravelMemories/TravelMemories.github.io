...
INSERT INTO travel (username, place, description, travel_date, latitude, longitude)
VALUES
('user1', 'Paris, France', 'Explored the iconic Eiffel Tower and indulged in delicious French pastries.', '2023-03-15', 48.8566, 2.3522),
('user2', 'Kyoto, Japan', 'Visited serene temples, enjoyed cherry blossoms, and experienced traditional tea ceremonies.', '2022-09-25', 35.0116, 135.7681),
('user3', 'New York City, USA', 'Explored Times Square, walked through Central Park, and saw a Broadway show.', '2022-05-10', 40.7128, -74.0060),
('user4', 'Rome, Italy', 'Visited the Colosseum, threw a coin in the Trevi Fountain, and savored authentic Italian pasta.', '2022-07-20', 41.9028, 12.4964),
('user5', 'Cape Town, South Africa', 'Enjoyed breathtaking views from Table Mountain and went on a safari in Kruger National Park.', '2023-01-05', -33.918861, 18.423300),
('user6', 'Barcelona, Spain', 'Strolled down La Rambla, admired Gaudi\'s architecture, and savored paella by the beach.', '2022-11-08', 41.3851, 2.1734),
('user7', 'Tokyo, Japan', 'Explored the bustling districts of Shibuya and Shinjuku, and tasted delicious ramen.', '2022-12-15', 35.6895, 139.6917),
('user8', 'London, UK', 'Visited the British Museum, walked along the River Thames, and experienced London\'s rich history.', '2022-06-02', 51.5074, -0.1278),
('user9', 'Rio de Janeiro, Brazil', 'Relaxed on Copacabana Beach, hiked up Sugarloaf Mountain, and celebrated Carnival.', '2022-03-04', -22.9068, -43.1729),
('user10', 'Dubai, UAE', 'Spectacular views from the Burj Khalifa, shopping at the Dubai Mall, and desert safari adventures.', '2022-08-19', 25.276987, 55.296249),
('user11', 'Marrakech, Morocco', 'Explored the vibrant souks, visited the Jardin Majorelle, and enjoyed traditional Moroccan cuisine.', '2022-04-12', 31.6348, -7.9896),
('user12', 'Sydney, Australia', 'Explored the Sydney Opera House, Bondi Beach, and the historic Rocks district.', '2022-10-30', -33.8688, 151.2093),
('user13', 'Istanbul, Turkey', 'Visited the Hagia Sophia, explored the Grand Bazaar, and cruised the Bosphorus.', '2022-07-25', 41.0082, 28.9784),
('user14', 'Prague, Czech Republic', 'Walked through Old Town Square, admired Prague Castle, and enjoyed Czech beer.', '2022-09-08', 50.0755, 14.4378),
('user15', 'Seoul, South Korea', 'Explored vibrant street markets, visited Gyeongbokgung Palace, and tried Korean BBQ.', '2022-11-27', 37.5665, 126.9780),
('user16', 'Vienna, Austria', 'Attended a classical concert, explored Schönbrunn Palace, and enjoyed Viennese coffee.', '2022-12-03', 48.8566, 2.3522),
('user17', 'Cairo, Egypt', 'Explored the Pyramids of Giza, visited the Sphinx, and cruised the Nile River.', '2022-02-18', 30.0444, 31.2357),
('user18', 'Amsterdam, Netherlands', 'Cycled along picturesque canals, visited Anne Frank House, and explored the Van Gogh Museum.', '2022-05-22', 52.3676, 4.9041),
('user19', 'Buenos Aires, Argentina', 'Danced the tango, explored Recoleta Cemetery, and enjoyed Argentine steak.', '2023-02-09', -34.6118, -58.4173),
('user20', 'Bangkok, Thailand', 'Visited Wat Pho, explored the Grand Palace, and experienced the vibrant street life.', '2022-07-01', 13.7563, 100.5018),
('user21', 'Istanbul, Turkey', 'Explored the Hagia Sophia, explored the Grand Bazaar, and cruised the Bosphorus.', '2022-08-12', 41.0082, 28.9784),
('user22', 'Bangkok, Thailand', 'Visited Wat Pho, explored the Grand Palace, and experienced the vibrant street life.', '2022-06-29', 13.7563, 100.5018),
('user23', 'Sydney, Australia', 'Explored the Sydney Opera House, Bondi Beach, and the historic Rocks district.', '2023-02-10', -33.8688, 151.2093),
('user24', 'Vienna, Austria', 'Attended a classical concert, explored Schönbrunn Palace, and enjoyed Viennese coffee.', '2022-10-18', 48.8566, 2.3522);
